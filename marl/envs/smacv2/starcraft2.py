...
class StarCraft2Env(MultiAgentEnv):
    ...
    def reset(self, episode_config={}):
        ...
        self.obs_ally = np.zeros((self.n_agents, self.n_agents))    
    ...
    def own_obs_agent(self, agent_id):
        ...
        if (
            ...
            loc_feats[0] = x / sight_range
            loc_feats[1] = y / sight_range
            ...
            for _, al_id in enumerate(al_ids):
                ...
                if ally_visible :
                    self.obs_ally[agent_id, al_id] = 1
    ...
    def get_obs_feats_size(self):
        
        num_object = self.num_objects
        feature_dim = 1 + 2 + 4 + self.get_obs_own_feats_size()
        
        return num_object, feature_dim
    ...
    def get_obs_size(self):
        ...
        if self.algorithm_name == "mast":
            ...
            n_objects, n_feats = self.get_obs_feats_size()
            return (
